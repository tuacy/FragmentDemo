...
import static com.tuacy.sharedelement.Constants.BACKGROUND_IMAGE_URLS;
...
public class DetailsFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, final Bundle savedInstanceState) {
		...
		mAlbumImage = rootView.findViewById(R.id.details_album_image);
		final ImageView backgroundImage = rootView.findViewById(R.id.details_background_image);

		View textContainer = rootView.findViewById(R.id.details_text_container);
		TextView albumTitleText = textContainer.findViewById(R.id.details_album_title);
